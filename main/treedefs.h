...
typedef struct _node {
  ...
  real   cellnphotons;        /* number of photons in the cell */
  double celldens;            /* cell density */
  int    cellindex;           /* deiktis gia ton an einai cell i body */
  double cellsize;             
  real   cellnumber;          /* sph particles the cell has */
...
#define cnum(x)      (((nodeptr) (x))->cellnumber) 
#define csize(x)     (((nodeptr) (x))->cellsize)
#define cid(x)       (((nodeptr) (x))->cellid)
#define cindex(x)    (((nodeptr) (x))->cellindex)
#define cnphotons(x) (((nodeptr) (x))->cellnphotons)
#define cdens(x)     (((nodeptr) (x))->celldens)
...
#define firstcid(x) (((cellptr) (x))->first)
...
void maketree2(bodyptr, int);           /* construct tree structure       */
...
global int real_ncell;                  /* how many virtual cells exist     */
global int global_index;                /* number of cells in second approach */
global double boundary;
/*
 * Force calculation.
 */
